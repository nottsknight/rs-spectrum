...
pub fn exchange(mem: &[u8]) -> DecodeResult {
    match mem {
        ...
        [0xed, 0xa0, ..] => Some((Instr::LDI, 2)),
        [0xed, 0xb0, ..] => Some((Instr::LDIR, 2)),
        [0xed, 0xa8, ..] => Some((Instr::LDD, 2)),
        [0xed, 0xb8, ..] => Some((Instr::LDDR, 2)),
        [0xed, 0xa1, ..] => Some((Instr::CPI, 2)),
        [0xed, 0xb1, ..] => Some((Instr::CPIR, 2)),
        [0xed, 0xa9, ..] => Some((Instr::CPD, 2)),
        [0xed, 0xb9, ..] => Some((Instr::CPDR, 2)),
        _ => None
    }
}
