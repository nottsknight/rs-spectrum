...
impl Z80 {
    ...
    pub fn execute(&mut self, instr: Instruction, memory: &mut [u8]) {
        match instr {
            ...
            // 8-bit Arithmetic
            Instruction::ADD_A_r(r) => min_time!(arith8::add_a_r(self, r, false); 1000),
            Instruction::ADD_A_n(n) => min_time!(arith8::add_a_n(self, n, false); 1750),
            Instruction::ADD_A_HL => min_time!(arith8::add_a_hl(self, memory, false); 1750),
            Instruction::ADD_A_IX(d) => min_time!(arith8::add_a_ix(self, d, memory, false); 4750),
            Instruction::ADD_A_IY(d) => min_time!(arith8::add_a_iy(self, d, memory, false); 4750),
            Instruction::ADC_A_r(r) => min_time!(arith8::add_a_r(self, r, true); 1000),
            Instruction::ADC_A_n(n) => min_time!(arith8::add_a_n(self, n, true); 1750),
            Instruction::ADC_A_HL => min_time!(arith8::add_a_hl(self, memory, true); 1750),
            Instruction::ADC_A_IX(d) => min_time!(arith8::add_a_ix(self, d, memory, true); 4750),
            Instruction::ADC_A_IY(d) => min_time!(arith8::add_a_iy(self, d, memory, true); 4750),
